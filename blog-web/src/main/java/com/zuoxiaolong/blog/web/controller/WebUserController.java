...
public class WebUserController extends WebBaseController {
    ...
    public String login(String username, String password) {
        JsonResponse jsonResponse = blogSdk.invokeApi(Api.WebUser_Login, CollectionUtils.newMap(new String[]{"username", "password"}, username, password));
    ...
    public String register(String username, String password) {
        JsonResponse jsonResponse = blogSdk.invokeApi(Api.WebUser_Register, CollectionUtils.newMap(new String[]{"username", "password"}, username, password));
        if (jsonResponse.success()) {
            loginSuccess(username, (String) jsonResponse.getData());
            return "/index/index";
        } else {
